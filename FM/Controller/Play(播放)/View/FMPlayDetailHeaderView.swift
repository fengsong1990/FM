...
class FMPlayDetailHeaderView: UIView {
    ...
    private lazy var subscibeBtn:UIButton = {
        let button = UIButton()
        button.backgroundColor = FMButtonColor
    ...
    func setUpUI(){
        self.blurImageView = UIImageView.init(frame:  CGRect(x:0 , y:0 , width: FMScreenWidth, height: self.frame.height - 80))
        ...
        self.imageView.snp.makeConstraints { (make) in
            ...
            make.top.equalTo(FMNavBarHeight+10)
